...
license: MIT
compatibility: Requires the qmd CLI. Run `qmd skill show` for version-matched instructions.
...
> qmd is a third-party tool by Tobi Lutke (MIT, https://github.com/tobi/qmd).
> This bootstrap is included for convenience; the qmd source is NOT vendored here.
